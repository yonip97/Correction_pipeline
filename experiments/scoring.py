...
def score(texts, summaries, metrics, device='auto', torch_dtype=torch.float16):
    results = {}
    for metric in metrics:
        if 'seahorse' in metric:
            factuality_metric = Seahorse_metrics(model_path='google/seahorse-xxl-q4',
                                                 ...
                                                 device=device, batch_size=1, torch_dtype=torch_dtype,
            ...
            factuality_metric = TrueTeacher(model_path='google/t5_11b_trueteacher_and_anli',
                                            ...
                                            device=device, batch_size=1, max_length=2048,
