...
from fact_pegasus.data import Data
from fact_pegasus.trainer import MyTrainer
#from entity_pertubation import EntityPertubation
from fact_pegasus.metric import Metric
    ...
    if training_args.do_predict:
        ...
        if training_args.predict_with_generate:
            ...
            output_prediction_file = os.path.join(
                    training_args.output_dir, "../../../../../Downloads/generated_predictions.txt"
                    )
