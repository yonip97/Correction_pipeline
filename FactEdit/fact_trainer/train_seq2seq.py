...
from fact_trainer_utils import compute_batched_sentence_rouge
...
if __name__ == "__main__":
    ...
    summarizer.hf_dataset = datasets.load_dataset('json', data_files={
    ...
    #summarizer.hf_dataset = datasets.load_dataset('xsum')
